...
from .bnse import *
from .kernels import MultiSpectralMixtureBlocked as MOSM
from .kernels import SpectralMixture, sm_unravel_hp
from .kernels import CrossSpectralMixture as CSM
from .kernels import SpectralMixtureLMC as SM_LMC
from .kernels import ConvolutionalGaussian as CONV

class model:
    #At model construction we define the number of components and the optimizer
    def __init__(self, number_of_components_q, data=None, optimizer = 'L-BFGS-B'):
...
############################# Basic model construction #####################################
    ...
    def build_model(self, kernel, type, parameters = {}):
        ...
        print(self.X_train_original)
        print(self.y_train_original)
        if(type == 'full'):
...
################################ Prediction ################################################
    ...
    def predict(self, X_prediction):
        ...
        print(self.prediction_mean)
        print(self.prediction_var)
